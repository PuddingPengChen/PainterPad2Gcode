...
public:
    ...
    void setExtruderOffset(int id, Pointc p);
    ...
    void writeMove(Pointc p, int speed, int lineWidth);
...
public:
    ...
    void addTravel(Pointc p);
    
    void addExtrusionMove(Pointc p, GCodePathConfig* config);
